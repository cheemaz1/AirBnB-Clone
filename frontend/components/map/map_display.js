...
class MapDisplay extends React.Component {
    ...
    componentDidMount() {
        ...
        if (!this.drawCities()) {
            this.markerManager.updateMarkers(this.props.homes, this.markerClickHandler.bind(this), this.props.type)
        }
    ...
    componentDidUpdate(prevProps) {
        if (isEqual(prevProps.query, this.props.query) && isEqual(prevProps.homes, this.props.homes)) return;
