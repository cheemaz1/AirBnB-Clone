  ...
  return (
    <footer id="all-page-footer">
      <div className="footer-list-container">
        <ul>
          <h3>About me</h3>
          <li><a href="https://github.com/cheemaz1" target="_blank" className="github">Github<i className="fab fa-github-square"> </i></a></li>
          <li><a href="https://www.linkedin.com/in/zayed-cheema-30521920a/" target="_blank" className="github">LinkedIn<i className="fab fa-linkedin"></i> </a></li>
          <li><a href="https://angel.co/u/zayed-cheema" target="_blank" className="github">AngelList<i className="fab fa-angellist"></i> </a></li>
        </ul>
        <ul>
          <h3>Contact</h3>
